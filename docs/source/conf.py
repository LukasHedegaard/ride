...
try:
    ...
    sys.path.append(os.path.join(PATH_ROOT, "ride"))
    import info
...
html_theme_path = [ride_sphinx_theme.get_html_theme_path()]
...
import ride
from ride.code import RideModule, RideMixin
